    ...
    <div class="flex flex-col md:flex-row w-full min-h-screen">
        ...
        <div class="w-full md:w-[55%] lg:w-[60%] flex flex-col justify-center items-center px-6 py-12 sm:px-16 lg:px-24 bg-white relative">
            <div class="w-full max-w-md my-auto">
                ...
                <div class="flex bg-slate-100 p-1 rounded-xl mb-8 w-full">
                    <a href="{{ route('login') }}" class="w-1/2 text-center py-2.5 text-sm font-semibold rounded-lg text-slate-500 hover:text-slate-900 transition">
                        Masuk
                    </a>
                    <a href="{{ route('register') }}" class="w-1/2 text-center py-2.5 text-sm font-semibold rounded-lg bg-white text-slate-900 shadow-sm transition">
                        Daftar
                    </a>
                </div>

                <div class="mb-6">
                    <h1 class="text-3xl font-bold text-[#0f2d4a] tracking-tight mb-2">Buat Akun Baru</h1>
                    <p class="text-slate-500 text-sm">Daftar untuk mulai melaporkan kasus</p>
                </div>
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-4 w-full">
                    ...
                    @if($errors->any())
                        <div class="p-3 bg-red-50 border border-red-200 rounded-xl mb-2">
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-[#0f2d4a] mb-1.5">Username</label>
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none text-slate-400">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                            </span>
                            <input type="text" name="username" value="{{ old('username') }}" required autofocus
                                class="w-full pl-11 pr-4 py-2.5 bg-[#f8fafc] border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#00a896] focus:border-transparent placeholder-slate-400 transition" 
                                placeholder="Pilih username unik">
                        </div>
                    </div>

                    <div>
                        <label class="block text-sm font-semibold text-[#0f2d4a] mb-1.5">Email</label>
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none text-slate-400">
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-[#0f2d4a] mb-1.5">Password</label>
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none text-slate-400">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/></svg>
                            </span>
                            <input type="password" name="password" required
                                class="w-full pl-11 pr-11 py-2.5 bg-[#f8fafc] border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#00a896] focus:border-transparent placeholder-slate-400 transition" 
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-[#0f2d4a] mb-1.5">Konfirmasi Password</label>
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none text-slate-400">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/></svg>
                            </span>
                    ...
                    <button type="submit" 
                        class="w-full bg-[#00a896] hover:bg-[#028074] text-white font-semibold py-3 px-4 rounded-xl shadow-md hover:shadow-lg transition-all duration-200 transform active:scale-[0.99] mt-2">
                        Daftar Akun
                    </button>
                </form>
                ...
                <p class="text-center text-sm text-slate-500 mt-6">
                    Sudah punya akun? 
                    <a href="{{ route('login') }}" class="font-bold text-[#00a896] hover:underline ml-1">Masuk di sini</a>
                </p>
